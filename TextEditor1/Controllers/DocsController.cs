...
namespace TextEditor1.Controllers
{
    ...
    {
        private readonly TextEditor1Context _context;

        public DocsController(TextEditor1Context context)
        {
            _context = context;
        }
        ...
        {
            var textEditor1Context = _context.Doc.Include(d => d.User);
            return View(await textEditor1Context.ToListAsync());
        }
